...
async function main() {
  ...
  console.error("Доступны следующие инструменты:");
  console.error(" - getLeads, getLead, createLead, updateLead, getLeadStatuses");
  console.error(" - getDeals, getDeal, createDeal, updateDeal, getDealCategories, getDealStages");
  console.error(" - getContacts, getContact");
  console.error(" - getActivities");
  console.error(" - addTimelineComment");
  console.error(" - getCallStatistics");
}
