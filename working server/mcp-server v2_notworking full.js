...
async function main() {
  ...
  console.error(`Всего инструментов зарегистрировано: ${Object.keys(server.tools).length}`);
  console.error(`Список доступных инструментов: ${Object.keys(server.tools).join(', ')}`);
}
